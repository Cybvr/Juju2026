...
export default function Home() {
  ...
  const faqs = [
    ...
    { q: "Does it work on MAC or Windows? 🖥️", a: "Yes! Since it's web-based, it works perfectly on both operating systems." },
    ...
    { q: "Is there a Money Back Guarantee Policy? 🛡️", a: "Yes! If you create one video and don't like it, we will refund all your money and let you keep the videos you created." },
  ]
    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-primary/20 overflow-x-hidden">
      ...
      <main>
        ...
        <section className="relative pt-24 pb-24 md:pt-44 md:pb-44 overflow-hidden">
          {/* Background Glow */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] bg-primary/10 blur-[160px] -z-10" />

          <div className="container mx-auto px-6 relative">
            <div className="max-w-4xl mx-auto text-center mb-16">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-muted border border-border text-foreground text-[10px] font-black uppercase tracking-wider mb-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                <h1>Faster Storytelling ⚡</h1>
              </div>
            ...
            <div className="relative max-w-6xl mx-auto h-auto min-h-[300px] md:h-[600px] flex flex-col md:flex-row items-center justify-center">
              ...
              <div className="relative md:absolute mt-8 md:mt-0 -bottom-10 md:-bottom-10 left-0 right-0 md:left-20 md:right-auto z-20 p-6 md:p-8 bg-background border border-border rounded-[1.5rem] shadow-2xl animate-in fade-in slide-in-from-left-12 duration-1000 delay-300 max-w-sm md:max-w-none mx-auto md:mx-0">
                <p className="text-base md:text-xl font-bold mb-6 text-foreground leading-snug">
                  A man driving an open car during summer vacation ☀️
                </p>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h4 className="text-lg font-bold mb-1 text-foreground">Full Length Text-To-Video 🎞️</h4>
              ...
              <div className="relative group">
                <div className="aspect-video rounded-3xl overflow-hidden border border-border bg-card flex items-center justify-center shadow-2xl relative">
                  ...
                  <FaPlayCircle className="w-12 h-12 text-white drop-shadow-lg opacity-90 group-hover:opacity-100 transition-opacity z-10" />
                </div>
        ...
        <section className="py-12 px-4 md:px-6">
          <div className="container mx-auto bg-card border border-border rounded-[2rem] p-8 md:p-16">
            <div className="mb-16">
              <h2 className="text-2xl md:text-3xl font-bold mb-3  text-foreground uppercase tracking-tight">Juju Builds The <span className="text-primary underline decoration-primary/30 underline-offset-4">ENTIRE</span> Video For You 🛠️</h2>
            ...
            <div className="mt-16 flex flex-col items-center md:items-start">
              <Link href="/auth/login">
                <Button className="text-sm py-6 px-6 md:px-8 font-black shadow-xl transition-all hover:scale-105 active:scale-95">
                  Get Access 🚀 <FaArrowRight className="ml-2 w-4 h-4" />
                </Button>
              </Link>
              <div className="flex items-center gap-4 mt-6 text-[10px] text-muted-foreground font-black uppercase tracking-wider">
                <span className="flex items-center gap-1"><FaShieldAlt className="w-3 h-3 text-primary" /> Support Included! 🤝</span>
                <span className="w-1 h-1 bg-border" />
                <span className="flex items-center gap-1"><FaClock className="w-3 h-3 text-primary" /> Monthly Access</span>
              </div>
            </div>
          </div>
        </section>
                ...
                <div className="space-y-3">
                  {group.items.map((item) => (
                    ...
                    >
                      ...
                      <FaArrowRight className="h-4 w-4 text-primary transition-transform group-hover:translate-x-1" />
                    </Link>
                  ))}
                </div>
                <Link href={group.href}>
                  <Button variant="outline" className="mt-8 w-full font-black">
                    Explore {group.label} →
                  </Button>
                </Link>
              </div>
        ...
        <section className="py-24 bg-muted border-b border-border overflow-hidden">
          <div className="container mx-auto px-6">
            <div className="mb-16">
              <h2 className="text-2xl md:text-3xl font-bold mb-6 text-foreground uppercase tracking-tight">Competitors Vs <span className="text-primary underline decoration-primary/30 underline-offset-4">JUJU</span> ⚔️</h2>
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="border-b border-border bg-muted/50">
                      ...
                      <th className="p-6 text-sm font-bold text-primary uppercase tracking-wider text-center bg-primary/5">Juju</th>
                    ...
                    {[
                      ...
                      <tr key={i} className="hover:bg-accent/50 transition-colors">
                        ...
                        <td className="p-6 text-center bg-primary/5">
                          <FaCheckCircle className="w-6 h-6 text-primary mx-auto" />
                        </td>
                        <td className="p-6 text-center text-xs text-muted-foreground">
                          {typeof row.c1 === 'boolean' ? (row.c1 ? <FaCheckCircle className="w-5 h-5 text-muted-foreground mx-auto" /> : <FaTimesCircle className="w-5 h-5 text-destructive/50 mx-auto" />) : row.c1}
                        </td>
                        <td className="p-6 text-center text-xs text-muted-foreground">
                          {typeof row.c2 === 'boolean' ? (row.c2 ? <FaCheckCircle className="w-5 h-5 text-muted-foreground mx-auto" /> : <FaTimesCircle className="w-5 h-5 text-destructive/50 mx-auto" />) : row.c2}
                        </td>
                        <td className="p-6 text-center text-xs text-muted-foreground">
                          {typeof row.c3 === 'boolean' ? (row.c3 ? <FaCheckCircle className="w-5 h-5 text-muted-foreground mx-auto" /> : <FaTimesCircle className="w-5 h-5 text-destructive/50 mx-auto" />) : row.c3}
                        </td>
                        <td className="p-6 text-center text-xs text-muted-foreground">
                          {typeof row.c4 === 'boolean' ? (row.c4 ? <FaCheckCircle className="w-5 h-5 text-muted-foreground mx-auto" /> : <FaTimesCircle className="w-5 h-5 text-destructive/50 mx-auto" />) : row.c4}
                        </td>
                      </tr>
                    ))}
                  </tbody>
        ...
        <section id="features" className="py-12 px-4 md:px-6">
          <div className="container mx-auto bg-card border border-border rounded-[2rem] p-8 md:p-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 text-sm">
              {[
                { title: "AI Video Wizard Engine 🪄", desc: "Type an idea or paste a script - Juju generates storyboard, scenes, voiceover, music, and final video automatically.", icon: FaMagic, image: "/images/marketing/wizard.webp" },
                { title: "Create Unlimited Toon Videos 🚀", desc: "Generate as many toon videos as you desire, empowering you to express your creativity without boundaries.", icon: FaRocket, image: "/images/marketing/adventure.webp" },
                { title: "10+ Visual Styles Included 🎨", desc: "Instantly switch the look of your entire video: 3D, classic, modern, comic book, illustration, and more.", icon: FaPalette, image: "/images/marketing/artist.webp" },
                { title: "Cloud-Rendered HD Exports ☁️", desc: "No heavy processing on your computer — Juju renders in the cloud and delivers a ready-to-download HD video.", icon: FaGlobe, image: "/images/marketing/cloud.webp" },
                { title: "Character Consistency Engine 👥", desc: "Create a character once - and keep the same look across the entire video (same face, same outfit).", icon: FaUsers, image: "/images/marketing/joyful.webp" },
                { title: "AI Music Composer 🎵", desc: "Generate original background music by mood — plus ducking, fade-in/out, and multiple variations.", icon: FaMusic, image: "/images/marketing/robt.webp" },
              ].map((f, i) => (
                  ...
                  <div className="p-10 md:p-16 relative z-10 border-r border-border/50">
                    ...
                    <ul className="max-w-md space-y-3 mb-12 text-left text-xs font-bold">
                      {[
                        ...
                        "Voiceover + background music included 🎙️",
                    ...
                    <Link href="/auth/login">
                      <Button className="w-full sm:w-auto text-xl py-8 px-12 font-bold shadow-xl transition-all hover:scale-105 active:scale-95">
                        Subscribe Now 🚀 <FaArrowRight className="ml-2 w-6 h-6" />
                      </Button>
                    </Link>
                    ...
                    <div className="mt-8 p-6 rounded-2xl bg-muted border border-border backdrop-blur-sm">
                      <div className="flex items-center gap-2 text-primary font-bold text-sm">
                        ...
                        <span>100% Money Back Guarantee 🛡️</span>
                      </div>
                    </div>
                  </div>
            ...
            <div className="space-y-3 max-w-4xl text-sm">
              {faqs.map((faq, i) => (
                <div key={i} className="rounded-2xl border border-border bg-background overflow-hidden transition-all hover:shadow-sm">
                  ...
                  >
                    <h2 className="text-lg font-bold text-foreground">{faq.q}</h2>
                    <FaChevronDown className={cn("w-5 h-5 transition-transform text-muted-foreground", activeFaq === i && "rotate-180")} />
                  </button>
                  {activeFaq === i && (
          ...
          <div className="container mx-auto bg-card border border-border rounded-[2rem] p-8 md:p-16 relative overflow-hidden">
            ...
            <div className="p-10 rounded-[2rem] bg-card border border-border relative max-w-3xl group shadow-xl">
              ...
              <div className="relative">
                ...
                <Link href="/auth/login">
                  <Button className="w-full text-lg md:text-2xl py-8 md:py-12 px-4 md:px-16 font-extrabold shadow-2xl transition-all ">
                    Get Access 🚀
                  </Button>
                </Link>
              </div>
