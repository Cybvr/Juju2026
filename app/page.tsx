          ...
          <div className="container mx-auto bg-card border border-border rounded-[2rem] p-8 md:p-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 text-sm">
              {[
                ...
                { title: "Cloud-Rendered HD Exports", desc: "No heavy processing on your computer — Juju renders in the cloud and delivers a ready-to-download HD video.", icon: FaGlobe, image: "/images/marketing/cloud.webp" },
